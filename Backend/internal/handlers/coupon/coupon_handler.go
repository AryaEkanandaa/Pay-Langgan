...
func NewCouponHandler(couponService *coupon.CouponService) *CouponHandler {
...
func (h *CouponHandler) GetByID(c echo.Context) error {
	...
	return utils.Success(c, "Coupon retrieved successfully", coup)
}
...
func (h *CouponHandler) Create(c echo.Context) error {
	...
	return utils.SuccessCreated(c, "Coupon created successfully", coup)
}
...
func (h *CouponHandler) Update(c echo.Context) error {
	...
	return utils.Success(c, "Coupon updated successfully", coup)
}
